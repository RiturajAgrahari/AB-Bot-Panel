    ...
    return (
        <div className="sidebar">
            ...
            <div className="sidebar_category">
                ...
                <Link to='/profiles' className={activeLink === 4 ? "sidebar_link active" : "sidebar_link"} onClick={() => DashboardActivateLink(4)}>                    
                ...
                <Link to='/logout' className={activeLink === 5 ? "sidebar_link active" : "sidebar_link"} onClick={() => DashboardActivateLink(5)}>                    
            ...
            <div className="sidebar_category">
                ...
                <Link to='/' className={activeLink === 6 ? "sidebar_link active" : "sidebar_link"} onClick={() => DashboardActivateLink(6)}>                    
